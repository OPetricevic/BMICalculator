...
struct CalculatorBrain {
    ...
    let normalColor =  #colorLiteral(red: 0.721568644, green: 0.8862745166, blue: 0.5921568871, alpha: 1)
    ...
    mutating func calculateBMI(height: Float,weight: Float) {
        ...
        if(bmiValue<18.5){
            ...
            bmi = BMI(value: bmiValue, advice: "Don't eat pies, you're fat!!", color: overweightColor)
        }
        
    }
    func getAdvice() -> String {
        return bmi?.advice ?? "No Advice for you, good luck!"
    }
